...
export class StructuralDirectiveComponent extends UnsubscribeService {
  ...
  @ViewChild('notesRef', { static: true }) notesRef!: TemplateRef<any>;
  @ViewChild('prosConsRef', { static: true }) prosConsRef!: TemplateRef<any>;
  @ViewChild('topicsRef', { static: true }) topicsRef!: TemplateRef<any>;
